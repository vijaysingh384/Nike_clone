...
function Jordan_Desktop() {
    ...
    return(
      ...
      <div className="">
        ...
        <img className="col-span-2 row-span-4" src="https://images-static.nykaa.com/uploads/04a491d3-a8eb-4f49-a48e-9610933f4610.png?tr=cm-pad_resize,w-900" alt="" loading="lazy" />
        <img className="col-span-2 row-span-4" src="https://images-static.nykaa.com/uploads/f8edf252-3627-40b4-9d92-6a70ef10add4.png?tr=cm-pad_resize,w-900" alt="" loading="lazy" />
        <img className="col-span-2 row-span-4" src="https://images-static.nykaa.com/uploads/15485339-9e3c-44fb-931d-3c20fa6f204b.png?tr=cm-pad_resize,w-900" alt="" loading="lazy" />
        <img className="col-span-2 row-span-4" src="https://images-static.nykaa.com/uploads/03a852f2-ce8d-438e-851f-5043c3eeff22.png?tr=cm-pad_resize,w-900" alt="" loading="lazy" />
        ...
        <div className="px-5 grid grid-cols-6 grid-rows-5 gap-4 mt-4">
          ...
          <div className="col-span-2 row-span-5"><img src="https://images-static.nykaa.com/uploads/cbb6b3d0-9ebd-445e-8eb7-8f5c05d23910.png?tr=cm-pad_resize,w-750" alt="" loading="lazy" /></div>
          <div className="col-span-2 row-span-5 col-start-3"><img src="https://images-static.nykaa.com/uploads/d1351a8e-80d1-44f4-af44-32bf5777afd5.png?tr=cm-pad_resize,w-750" alt="" loading="lazy" /></div>
          <div className="col-span-2 row-span-5 col-start-5"><img src="https://images-static.nykaa.com/uploads/c3c93953-e770-473d-9a91-24b341267c82.png?tr=cm-pad_resize,w-750" alt="" loading="lazy" /></div>
        </div>
         <Product_section
              label="Featured"
                title="Best Sellers"

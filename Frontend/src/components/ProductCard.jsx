...
function ProductCard({ product }) {
    ...
    const handleAddToCart = async () => {
        ...
        try {
            const res = await fetch(`http://localhost:3001/addtocart/${product._id}`, {
    ...
    return (
        <div className="group cursor-pointer rounded-xl overflow-hidden">
            ...
            {/* Image Container */}
            <div className="relative bg-white flex items-center justify-center h-[300px] w-[320px] overflow-hidden">
                ...
                <div className="absolute top-3 left-3 bg-white rounded-full p-2 shadow cursor-pointer">
                    <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="#111" strokeWidth="1.5">
